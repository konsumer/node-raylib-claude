...
const bgImage = LoadImage("examples/resources/cyberpunk_street_background.png")     // Loaded in CPU memory (RAM)
const bgTexture = LoadTextureFromImage(bgImage)          // Image converted to texture, GPU memory (VRAM)

const fgImage = LoadImage("examples/resources/cyberpunk_street_foreground.png")     // Loaded in CPU memory (RAM)
const fgTexture = LoadTextureFromImage(fgImage)          // Image converted to texture, GPU memory (VRAM)
